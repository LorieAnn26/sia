...
<body>
	<div id="receiptContainer" style="width: 620px;padding-bottom: 50px;padding-top: 20px;border: 1px solid #d0d0d0;margin: 0 auto;border-radius: 5px;padding-left: 10px;padding-right: 10px;">
		<h3 style="font-size: 16px;color: #828282;text-align: right;border-bottom: 1px solid #cccccc;padding-bottom: 10px;margin-top: 10px;">Receipt</h3>
		<div>
			<table>
				<tbody>
					<tr>
						<td><h3 style="font-size: 23px;text-transform: uppercase;color:#5094dc;">Sagittarius Marketing Inc.</h3></td>
					</tr>
					<tr>
					  <td><span style="font-weight: bold;font-size: 13px;">Address: </span> <span>1900 Quirino Ave Manila</span></td>
					</tr>
					<tr>
					  <td><span style="font-weight: bold;font-size: 13px;">Contact #: </span> <span>8887-5555 | 0918-887-5555 | 0917-897-7555</span></td>
					</tr>
					<tr>
					...
					<tr>
						<td width="50%" style="vertical-align: top;">
							<table>
								<tbody>
									<tr>
										<td>
											<h3 style="font-size: 15px;font-weight: bold;text-transform: uppercase;">Customer Details:</h3>
										</td>
									</tr>
									<tr>
										<td>
						...
						<td width="50%" style="vertical-align: top;">
							<table>
								<tbody>
									<tr>
									  <td><h3 style="font-size: 15px;font-weight: bold;text-transform: uppercase;">Order Details: </h3></td>
									</tr>
									<tr>
